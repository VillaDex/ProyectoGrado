...
<head>
    ...
    <style>
        ...
        .dia-activo { background-color: #e9f7ef; }
    </style>
</head>
<body>
    <div class="container py-4">
        <div class="reporte-container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><i class="fas fa-chart-line text-success me-2"></i>Reporte Semanal de Ventas</h1>
            ...
            <div class="resumen-semana">
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <h4 class="text-success">Total Ventas: ${{ number_format($total_ventas, 2) }}</h4>
                        <p class="mb-0"><strong>Cantidad de transacciones:</strong> {{ $ventas->count() }}</p>
                    </div>
                </div>
            </div>

            <div class="grafica-container">
            <h4 class="mb-4"><i class="fas fa-chart-bar me-2"></i></h4> 
                <div class="chart">
                    @php
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tfoot>
                        <tr class="table-active">
                            <td colspan="5" class="text-end"><strong>Total Semana:</strong></td>
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <form action="{{ route('reportes.ventas.descargar') }}" method="GET">
