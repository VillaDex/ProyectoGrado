    ...
    <div class="register-container">
        <div class="register-form">
            ...
            <div class="error-message">
                ...
                <span>Hubo un error. Por favor, revisa los datos ingresados.</span>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <button type="submit" class="btn btn-primary">
                    Guardar Contraseña <i class="fas fa-arrow-right" style="margin-left: 10px;"></i>
                </button>
            </form>
        ...
        <div class="register-image">
            <div class="overlay">
                <h2 style="color: white; margin-bottom: 20px;">Crea una Nueva Contraseña!</h2>
                </ul>
            </div>
        </div>
    </div>
